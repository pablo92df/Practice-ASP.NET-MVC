...
namespace ManejoPresupuesto.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        //permite acceder a esta vista sin estar logueado
        [AllowAnonymous]
        ...
        public IActionResult Login()
        {
            ...
            {
                //solamente si esta autenticado
                //un claims es la informacion del usuario
        ...
        public async Task<IActionResult> Login(LoginViewModel modelo)
        {
            ...
            //lockoutfailure es para cuando el usuario se equivoca varias veces al poner la cuenta
